...
public class REF_GPT1 {
    ...
    public REF_GPT1(String number, String dpd, String clientFullName, String nombre, String speiClave, String oxxoReference, String adeudo, String tel, String algoritmo, String tipoCliente) {
        this.number = number;
        this.dpd = dpd;
        this.clientFullName = clientFullName;
        this.nombre = nombre;
